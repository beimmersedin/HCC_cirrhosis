# =============================================================================
#  Peak-to-Gene LinkPeaks — TC Macrophages
#  ATAC Peak과 RNA 발현 간 상관관계를 계산 (시간이 오래 걸리는 단계)
#  결과: Macrophages_Peak_Gene_Links.csv
# =============================================================================
...
write.csv(all_links, paste0(output_dir, "Macrophages_Peak_Gene_Links.csv"))
message("저장 완료: Macrophages_Peak_Gene_Links.csv (", nrow(all_links), " links)")
