...
WGCNA_OBJ_PATH = os.path.join(BASE_DIR, "WGCNA_80/results_output/Endothelial_Cells/Endothelial_Cells_Network.p")
OUT_DIR = os.path.join(BASE_DIR, "WGCNA_80/results_output/Endothelial_Cells/hub_genes")
