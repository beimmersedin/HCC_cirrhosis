...
WGCNA_OBJ_PATH = os.path.join(BASE_DIR, "WGCNA_80/results_output/Plasma_Cells/Plasma_Cells_Network.p")
OUT_DIR = os.path.join(BASE_DIR, "WGCNA_80/results_output/Plasma_Cells/hub_genes")
