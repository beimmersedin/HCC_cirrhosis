...
WGCNA_OBJ_PATH = os.path.join(BASE_DIR, "WGCNA_80/results_output/Macrophages/Macrophages_Network.p")
OUT_DIR = os.path.join(BASE_DIR, "WGCNA_80/results_output/Macrophages/hub_genes")
