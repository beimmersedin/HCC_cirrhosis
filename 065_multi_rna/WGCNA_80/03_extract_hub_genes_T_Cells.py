...
WGCNA_OBJ_PATH = os.path.join(BASE_DIR, "WGCNA_80/results_output/T_Cells/T_Cells_Network.p")
OUT_DIR = os.path.join(BASE_DIR, "WGCNA_80/results_output/T_Cells/hub_genes")
