...
WGCNA_OBJ_PATH = os.path.join(BASE_DIR, "WGCNA_80/results_output/Mesenchymal/Mesenchymal_Network.p")
OUT_DIR = os.path.join(BASE_DIR, "WGCNA_80/results_output/Mesenchymal/hub_genes")
