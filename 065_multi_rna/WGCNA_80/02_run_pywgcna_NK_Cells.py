...
INPUT_PATH = os.path.join(BASE_DIR, "WGCNA_80/results_output/NK_Cells_80_pb_n50.h5ad")
OUT_DIR = os.path.join(BASE_DIR, "WGCNA_80/results_output/NK_Cells/")
